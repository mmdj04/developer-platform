...
interface CustomerColumn {
  width: string;
  items: Array<{ type: "logo"; name: string; icon: React.ReactNode } | { type: "featured"; name: string; description: string }>;
}

const logo = (name: string, icon: React.ReactNode) => ({ type: "logo" as const, name, icon });
  ...
  return (
    <div className="flex min-h-svh flex-col">
      <div className="flex flex-1 flex-col items-center justify-center px-6 min-h-[85vh]">
        ...
        <p className="text-scale-11 text-sm md:text-base text-center max-w-md mt-4">
          Full-stack developer em React, Next.js, Vue, Svelte, Flutter & IA
        </p>
        <p className="text-scale-10 text-xs md:text-sm text-center max-w-md mt-2">
          Supabase · TypeScript · Node.js · Postgres · Tailwind · shadcn/ui
        </p>
      ...
      <div className="text-center text-sm text-scale-11 pb-8">
        <p>Domine o stack inteiro. Do frontend ao banco de dados.</p>
      </div>
      ...
      <div className="container relative mx-auto px-6 lg:px-16 xl:px-20 pb-16 md:pb-24">
        <div className="flex flex-col xl:flex-row gap-8 items-center justify-between">
          <div className="text-center xl:text-left text-2xl md:text-4xl text-scale-11 leading-tight">
            Construa com <span className="text-scale-12">qualquer framework</span>
          </div>
      ...
      <div className="sm:py-18 container relative mx-auto px-6 py-16 md:py-24 lg:px-16 lg:py-24 xl:px-20 text-center flex flex-col items-center">
        <h3 className="text-2xl md:text-4xl font-semibold tracking-tight text-scale-12">
          <span>Dashboard completo para</span><br className="hidden sm:block" />
          <span className="text-scale-11">seu próximo projeto.</span>
        </h3>
      ...
      <div className="border-t border-scale-5 py-8 sm:py-16 md:py-24 text-center px-6">
        <h2 className="text-2xl md:text-4xl font-semibold tracking-tight text-scale-12">
          <span className="text-scale-11">Pronto para construir algo incrível?</span>
          <span className="block sm:inline"> Vamos codar.</span>
        </h2>
