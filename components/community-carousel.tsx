  ...
  return (
    <div className="relative w-screen mt-8" style={{ marginLeft: "calc(-50vw + 50%)", marginRight: "calc(-50vw + 50%)" }}>
      ...
      <div className="md:hidden relative px-6 lg:px-16 xl:px-20">
        ...
        <div className="pointer-events-none absolute inset-y-0 left-0 w-16 bg-linear-to-r from-transparent via-scale-1/40 to-scale-1" />
        <div className="pointer-events-none absolute inset-y-0 right-0 w-16 bg-linear-to-l from-transparent via-scale-1/40 to-scale-1" />
      </div>
    </div>
  );
}
